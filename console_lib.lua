...
function Console:Window(consoledebugger)
	...
	Command.BackgroundColor3 = Color3.fromRGB(16, 16, 16)
	Command.BorderSizePixel = 0
	Command.Position = UDim2.new(0, 10, 0, 449)
	Command.Size = UDim2.new(0, 580, 0, 35)
	Command.ZIndex = 2

	Outline_A.Name = "Outline_A"
	Outline_A.Parent = Command
	Outline_A.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
	Outline_A.BorderSizePixel = 0
	Outline_A.Position = UDim2.new(0, 531, 0, 0)
	Outline_A.Size = UDim2.new(0, 2, 0, 35)
	Outline_A.ZIndex = 5
	...
	Input.Position = UDim2.new(0.0209226403, 0, 0.171428576, 0)
	Input.Size = UDim2.new(0, 437, 0, 23)
	...
	Run.Position = UDim2.new(0, 545, 0, 6)
	Run.Size = UDim2.new(0, 23, 0, 23)
	Run.Image = "rbxassetid://7072707704"
	Run.ImageColor3 = Color3.fromRGB(25, 25, 25)
